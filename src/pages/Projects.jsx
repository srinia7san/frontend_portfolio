  ...
  const [projectData, setProjectData] = useState([
    {
      ...
      description: "Developed a full-stack Inventory & Supply Chain Management System. Implemented inventory, supplier, order, and shipment management with JWT authentication, RBAC, analytics dashboards, and WebSocket-based real-time tracking.",
      tech: [
        { _id: "t1-1", name: "React.js" },
        { _id: "t1-2", name: "Node.js" },
        { _id: "t1-3", name: "Express.js" },
        { _id: "t1-4", name: "PostgreSQL" },
      ]
    },
    {
      _id: "2",
      title: "AI Data Analyst Assistant",
      description: "Developed an AI-powered Natural Language-to-SQL platform improving schema retrieval accuracy from 55% to 87%. Built a vector-based RAG pipeline with schema retrieval, foreign-key graph expansion, and automated Plotly visualizations for conversational business intelligence. Automated end-to-end SQL generation and data visualization.",
      tech: [
        { _id: "t2-1", name: "LangGraph" },
        { _id: "t2-2", name: "Gemini" },
        { _id: "t2-3", name: "Pinecone" },
        { _id: "t2-4", name: "PostgreSQL" },
        { _id: "t2-5", name: "RAG" },
        { _id: "t2-6", name: "Plotly" },
      ]
    }
  ]);
