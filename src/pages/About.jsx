...
const About = () => {
    const [profile, setProfile] = useState({
        ...
        location: "Mamallapuram, Tamilnadu",
        summary: "Full Stack Developer with hands-on experience in building scalable web applications using React.js, Node.js, Express.js, FastAPI, PostgreSQL, and MongoDB. Skilled in REST APIs, WebSockets, LangChain, RAG, LLM integration, Docker, and AWS. Passionate about developing high-performance backend systems and AI-powered applications."
    });
